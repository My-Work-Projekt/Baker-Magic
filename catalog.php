...
<div class="headercont" style="background-color: BlanchedAlmond;">
		...
		<p style="color: DarkGray; margin-left: 3px;">Каталог</p>
	</div>
				<h1 class="choice_h1"><big>Каталог</big></h1>
				<h3 class="choice_h3" style="margin-right: auto; margin-left: 85px;"><big>Выбор категории:</big></h3>
				<div class="catalog_imgs_cont">
					<a href="torts.php" class="catalog_hi_card" style="background-image:  url(img/tortiki_mini-prais.jpeg);">Торты</a>
					<a href="keks.php" class="catalog_hi_card" style="background-image:  url(img/ponchiki_mini-prais.jpeg);">Кексы</a>
					<a href="ponchiki.php" class="catalog_hi_card" style="background-image:  url(img/bulochki_mini-prais.jpeg);">Пончики</a>
					<a href="bun.php" class="catalog_hi_card" style="background-image:  url(img/keksi_mini-prais.jpeg);">Булочки</a>
				</div>
			</div>
