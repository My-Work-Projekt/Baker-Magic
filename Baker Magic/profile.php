...
<div class="prifile_">
    <h2 class="h2_dan">Ваш профиль</h2>
    <h2 class="h2_dan" style="font-size: 25px;">Данные пользователя</h2>
    <p class="p_dan" style="font-size: 22px;">Логин: <?php echo $_SESSION['login']; ?></p>
    <p class="p_dan" style="font-size: 22px;">Email: <?php echo $_SESSION['email']; ?></p>
    <form action="personal_data.php" method="get">
        <button type="submit" class="personal_dan">Личные данные</button>
    </form>
</div>
